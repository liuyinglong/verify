...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__defaultRules__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__domTools__ = __webpack_require__(2);
/**
 * Created by focus on 2017/4/14.
 */
...
const validate = function (field, rule) {
    ...
    let vm = self;                         //Vue组件对象
    let value = __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.get(vm, field);
    ...
    // 为字符串时调用默认规则
    if (is("String", rule)) {
        rule = __WEBPACK_IMPORTED_MODULE_0__defaultRules__["a" /* default */][rule];
    }
    ...
    //错误列表
    let $error = __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.get(vm.$verify.$errors, field);
...
Verify.prototype.check = function (group) {
    ...
    return verifyQueue.map(function (item) {
            if (__WEBPACK_IMPORTED_MODULE_1_lodash___default.a.get(rules, item)) {
                __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.set(vm.$verify.$errors, item, []);
                return validate.call(self.vm, item, __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.get(rules, item));
            }
        }).indexOf(false) === -1;
...
const verifyInit = function (_Vue, options) {
    ...
    if (options && options.rules) {
        Object.assign(__WEBPACK_IMPORTED_MODULE_0__defaultRules__["a" /* default */], __WEBPACK_IMPORTED_MODULE_0__defaultRules__["a" /* default */], options.rules);
    }
    Vue.mixin({
        beforeCreate: init
    });
    ...
    Vue.directive("verify", {
        bind: function (el, binding, vnode, oldVnode) {
            ...
            el.addEventListener("focus", function () {
                __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.set(vm.$verify.$errors, expression, []);
            });
            let group;
            ...
            vm.$watch("$verify.$errors." + expression, function (val) {
                if (val.length) {
                    __WEBPACK_IMPORTED_MODULE_2__domTools__["a" /* default */].addClass(el, errorClass);
                } else {
                    __WEBPACK_IMPORTED_MODULE_2__domTools__["a" /* default */].removeClass(el, errorClass);
                }
            })
        }
    });
    ...
    Vue.directive("verified", {
        update: function (el, binding, vnode, oldVnode) {
            if (binding.value && Array.isArray(binding.value) && binding.value.length > 0) {
                __WEBPACK_IMPORTED_MODULE_2__domTools__["a" /* default */].apply(el, true);
                ...
                __WEBPACK_IMPORTED_MODULE_2__domTools__["a" /* default */].apply(el, false);
                el.innerHTML = "";
            }
        }
    })
